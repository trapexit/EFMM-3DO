...
#include "dssupport/DataStreamDebug.h"
#include "dssupport/DataStreamLib.h"
#include "dssupport/DataAcq.h"
#include "dssupport/CPakSubscriber.h"
#include "dssupport/SAudioSubscriber.h"
#include "dssupport/ControlSubscriber.h"
...
initstreaming ()
{
	...
	if (InitCPakCel(streamcb,sc_cpak,&cpakrec,0,1) < 0)
